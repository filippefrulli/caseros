...
export function OrderConfirmedEmail({ buyerName, orderId, items, totalAmount, currency, appUrl }: Props) {
    ...
    <Html>
      ...
      <Body style={body}>
        <Container style={container}>
          ...
          <Text style={text}>
            Thanks for your purchase! Your order <strong>#{shortId}</strong> has been confirmed and the seller has been notified.
          </Text>
          ...
          <Hr style={hr} />
          <Text style={footer}>
            Caseros: original goods from EU makers.
          </Text>
        </Container>
      </Body>
    </Html>
